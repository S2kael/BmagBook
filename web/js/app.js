$(function () {
    ...
    function check(component){
        var $inputWrapper = $(component).parent();
        if (component.value === ""
            || (component.tagName === "SELECT" && (component.value === "Day" || component.value === "Month" || component.value === "Year"))
        ){
        ...
        if ($inputWrapper.attr('id') === 'last-name') {
            $inputWrapper.children('span.error-popup').removeClass('error-popup-bottom').hide();
        } else {
            $inputWrapper.children('span.error-popup').removeClass('error-popup-right').hide();
        }
    }
    ...
    $('#reg-button').on('click', function () {
        ...
        $.each($regInput, function (key, value) {
            check(this);
            if (value.value === "" || (value.tagName === "SELECT" && (value.value === "Day" || value.value === "Month" || value.value === "Year"))){
                result = false;
            }
        });
